...
function utp_register_sidebars()
{
  ...
  if (function_exists('register_sidebar')) {
    ...
    register_sidebar(array(
      ...
      'after_widget'  =>  '</div>',
      'before_title'  =>  '<h3 class="titulowidget2">',
      'after_title'   =>  '</h3>'
    ));
    ...
    register_sidebar(array(
      ...
      'id'            =>  'bannerPrincipal',
      'description'   =>  'Esoacio para el banner principal', 'tutotic',
...
{ ?>
  <style type="text/css">
    ...
    .login h1 a {
      height: 150px;
      background-image: url(https://pruebacrie.utp.edu.co/imageneidentidad/wp-content/themes/plantilla-utp/img/logoutp.png) !important;
    ...
    .login form {
      background: #fff;
      box-shadow: 0 1px 3px rgb(0, 80, 96, 0.3) !important;
    }

    .wp-core-ui .button-primary {
      background: #0f3d6a !important;
      border-color: #0f3d6a !important;
      box-shadow: 0 1px 0 #0f3d6a !important;
      color: #fff !important;
      text-decoration: none !important;
      text-shadow: 0 -1px 1px #0f3d6a, 1px 0 1px #0f3d6a, 0 1px 1px #0f3d6a, -1px 0 1px #0f3d6a !important;
    }

    .login #backtoblog a:hover,
    .login #nav a:hover,
    .login h1 a:hover {
      color: #0f3d6a !important
    }
