...
<section>
	...
	<article class="row contenido-noticias">
		<div class="col-lg-4 px-0 contenido-noticias__imagen">
			...
			<div class="imagen-post">
				...
				<?php } else { ?>
					...
					<a href="<?php the_permalink(); ?>"><img src="<?php bloginfo('template_directory');?>/img/imgPorDefecto.png" alt="UTP_DESTACADAS" title="Universidad Tecnológica de Pereira"></a>
		...
		<div class="col-lg-8 row align-content-between py-2">
			<div class="container-titles" >
				<div class="col-12 post-title-new">
					<h3><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a><!--titulo de los post--></h3>
				</div>
				<div>
					<p class="subtitle-category text-center"><?php the_category(','); ?></p><!--fecha, hora y categoria de los post-->
				</div>
			</div>
